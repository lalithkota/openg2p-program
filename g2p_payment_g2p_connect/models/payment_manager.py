...
class G2PPaymentManagerG2PConnect(models.Model):
    ...
    def _send_payments(self, batches):
        ...
        for batch in batches:
            ...
            try:
                ...
                token = self.create_jwt_token(json.dumps(batch_data, indent=None, separators=(",", ":"), sort_keys=True))
                headers = {
    ...
    def payments_status_check(self, id_):
        ...
        for batch in batches:
            ...
            try:
                ...
                token = payment_manager.create_jwt_token(json.dumps(status_data, indent=None, separators=(",", ":"), sort_keys=True))
                headers = {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
                    "Signature": token,
    ...
    def _create_envelope_g2p_bridge(self, cycle):
        ...
        try:
            token = self.create_jwt_token(json.dumps(envelope_request_data, indent=None, separators=(",", ":"), sort_keys=True))
            headers = {
                "Accept": "application/json",
                "Content-Type": "application/json",
                "Signature": token,
